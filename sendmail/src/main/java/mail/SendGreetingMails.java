...
public class SendGreetingMails {
    private static String myEmailAccount = "mail_demo2@163.com";
    private static String myEmailPassword = "wang123456";
    ...
    public static void sendMail(String first_name,String receiveMailAccount) throws Exception{
